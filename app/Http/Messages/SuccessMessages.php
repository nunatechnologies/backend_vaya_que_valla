...
{
    public const LOGIN_SUCCESS = "LOGIN EXITOSO";
    public const LOGOUT_SUCCESS = "Cierre de Sesion Exitoso";
    public const UPDATE_SUCCESS = "ACTUALIZACIÓN EXITOSA";
    public const DELETE_SUCCESS = "ELIMINACIÓN EXITOSA";
